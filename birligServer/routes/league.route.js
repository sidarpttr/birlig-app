...
const { playerInLeague } = require("../middlewares/verifyPlayer");
...
router.route('/:leagueId').get(controller.getLeagueById); //OOK
...
router.route("/:leagueId/player").get(controller.getAllProfiles).post(controller.addPlayerToLeague); //OK

//LİGTEKİ BİR OYUNNCU
router.route("/profile/:profileId").get(controller.getProfileById); //OK

//LİGTEKİ BİR OYUNCUNUN O LİGTEKİ TÜM MAÇLARI
router.route("/:leagueId/profile/:playerId/mac").get(controller.getAllLeagueMatchesForProfile); 
